"""
Adapter: PVS (Passive Vehicular Sensors) -> Telemachus format
...
Output: Telemachus Telemachus Parquet (100Hz IMU / ~1Hz GPS, downsampled to 10Hz)
"""
...
def adapt(input_dir: str, output_dir: str) -> list[Path]:
    """Convert PVS dataset to Telemachus Telemachus Parquet."""
    ...
    # Keep speed as-is (forward-filled is valid for Telemachus format).
