"""
Adapter: AEGIS Automotive Sensor Data (Zenodo) -> Telemachus format
...
Output: Telemachus Telemachus Parquet per trip (multi-rate ~24Hz IMU / ~1Hz GPS)
"""
...
def adapt(input_dir: str, output_dir: str) -> list[Path]:
    """Convert all AEGIS trips to Telemachus Telemachus Parquet."""
