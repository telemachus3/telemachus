...
def cmd_adapt(args):
    ...
    print(f"Adapting {source} -> Telemachus format ...")
...
def main():
    ...
    a = sub.add_parser("adapt", help="Convert third-party dataset to Telemachus format")
    ...
    a.add_argument("-o", "--output", required=True, help="Output directory for Telemachus Parquet files")
